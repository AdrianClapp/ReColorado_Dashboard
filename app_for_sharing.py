# -*- coding: utf-8 -*-
"""app_for_sharing.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/17_c7qMs8INoiP5BtH6uU70wRmEOaDk0s
"""
...
# Ensure 'Year' column exists by extracting it from 'CloseDate' if necessary
for df in [df_post, df_pre1, df_pre2]:
    if 'Year' not in df.columns and 'CloseDate' in df.columns:
